...
term monitoring locations around the Bay.
...
`station`, no `station_name` value is carried over.
...
and trends. They will both get removed from the working data in later steps of
data preparation.
...
We need to regenerate the long-form data, to facilitate faceted graphics. We
retain temperature as a predictor variable.
